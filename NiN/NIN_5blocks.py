...
train_loader = torch.utils.data.DataLoader(
    train_set, batch_size=128, sampler=tr_sampler,num_workers=0)
# %%
val_loader = torch.utils.data.DataLoader(
    train_set, batch_size=100, sampler=val_sampler,num_workers=0)
...
# ...........save model...........
torch.save(model.state_dict(), "./NiN_model_4blocks.pt")
# ............writing loss.....
